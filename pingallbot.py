...
Don't forget to join my [channel](http://t.me/Samilbots) to recieve information on all the latest updates.
...
If you have any questions on how to use me, feel free to ask in my [support group](https://t.me/teletipsofficialontopicchat). More on my [Owner](https://t.me/Samilben).
'''
  await teletips.send_message(message.chat.id, text, disable_web_page_preview=True)
